package com.example.application.views.dashboard1;


import com.example.application.views.dashboard1.ServiceHealth.Status;
...
@Route(value = "")
@RouteAlias(value = "")
public class Dashboard1View extends Main {
